...
function preload() {
  ...
  this.load.image('L', 'images/lose.jpg')
  this.load.image('W', 'images/won.jpg')
...
function update() {
  if(winn){var wi  = this.add.sprite(500, 300, 'W')}
  
  if(counter/50>-61&!winn){
    counter--;
  if(counter/50<10){
    tiempo2.setText('Time ' + Math.trunc((counter / 50)+61));
  }}
  if(counter/50==-61){

    var ls = this.add.sprite(500, 300, 'L')
...
function cargaInicial(game) {
  ...
  clr = game.add.text(880, 93, '', { fontSize: '16px', fill: '#0000FF' });
  cud = game.add.text(880, 173, '', { fontSize: '16px', fill: '#0000FF' });
  cd1 = game.add.text(873, 263, '', { fontSize: '16px', fill: '#0000FF' });
  cd2 = game.add.text(873, 343, '', { fontSize: '16px', fill: '#0000FF' });
  cd3 = game.add.text(885, 423, '', { fontSize: '16px', fill: '#0000FF' });
  cd4 = game.add.text(885, 523, '', { fontSize: '16px', fill: '#0000FF' });
